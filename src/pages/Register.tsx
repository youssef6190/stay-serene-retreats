...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to HotelLux! Your account has been created successfully.",
      });
      navigate("/dashboard");
    }, 1000);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-secondary-50 to-accent-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1564501049412-61c2a3083791?auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center opacity-5"></div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-gray-900">HotelLux</span>
          </Link>
        </div>
        ...
        <Card className="shadow-luxury border-0">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full h-12 gradient-primary text-white hover:opacity-90 font-semibold"
                disabled={isLoading}
              >
